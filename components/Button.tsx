...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-purple-600 hover:bg-purple-700 text-white shadow-md shadow-purple-500/20 focus:ring-purple-500",
    outline: "border-2 border-gray-300 dark:border-gray-600 hover:border-brand-500 dark:hover:border-brand-500 hover:text-brand-500 text-gray-700 dark:text-gray-300 bg-transparent",
